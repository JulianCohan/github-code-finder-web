...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayResults(results) {
        ...
        results.forEach((result, index) => {
            ...
            cardHeader.appendChild(repoInfo);
            cardHeader.appendChild(scoreInfo);
            ...
            metadata.innerHTML = `
                <p class="mb-1"><strong>File:</strong> <a href="${result.file_url}" target="_blank" class="text-decoration-none">${result.file_path}</a></p>
