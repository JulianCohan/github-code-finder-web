...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleSearch(e) {
        ...
        if (searchIconBtn) searchIconBtn.disabled = true;
        ...
        try {
            ...
            const response = await fetch(apiEndpoint, {
                ...
                body: JSON.stringify({
                    ...
                    min_stars: parseInt(minStars || "0"),
                    context_lines: parseInt(contextLines || "5")
                })
            });
            ...
            if (searchIconBtn) searchIconBtn.disabled = false;
